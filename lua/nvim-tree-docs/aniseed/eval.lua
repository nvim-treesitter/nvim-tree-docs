...
local a, compile, fennel, fs, nvim = autoload("nvim-tree-docs.aniseed.core"), autoload("nvim-tree-docs.aniseed.compile"), autoload("nvim-tree-docs.aniseed.fennel"), autoload("nvim-tree-docs.aniseed.fs"), autoload("nvim-tree-docs.aniseed.nvim")
