...
local a, fs, nvim, str = autoload("nvim-tree-docs.aniseed.core"), autoload("nvim-tree-docs.aniseed.fs"), autoload("nvim-tree-docs.aniseed.nvim"), autoload("nvim-tree-docs.aniseed.string")
