...
local _2amodule_name_2a = "nvim-tree-docs.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("nvim-tree-docs.aniseed.core"), autoload("nvim-tree-docs.aniseed.env"), autoload("nvim-tree-docs.aniseed.eval"), autoload("nvim-tree-docs.aniseed.nvim")
