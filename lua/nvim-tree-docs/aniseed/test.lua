...
local function _2_(...)
  ...
  local function _2_()
    return {require("nvim-tree-docs.aniseed.core"), require("nvim-tree-docs.aniseed.nvim"), require("nvim-tree-docs.aniseed.string")}
  end
  ok_3f_0_, val_0_ = pcall(_2_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {require = {a = "nvim-tree-docs.aniseed.core", nvim = "nvim-tree-docs.aniseed.nvim", str = "nvim-tree-docs.aniseed.string"}}
    return val_0_
  else
    return print(val_0_)
  end
